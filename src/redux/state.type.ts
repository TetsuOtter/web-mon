...
import { TTimetableRowDocument, TTimetableDocument, TLineDocument } from "../firestore/DBCtrler.types";
...
export type TStationDataListStruct = (DocId & TTimetableRowDocument);
